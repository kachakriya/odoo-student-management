...
class TestImportModule(odoo.tests.TransactionCase):
    ...
    def test_import_zip(self):
        ...
        files = [
            ('foo/__manifest__.py', self.manifest_content(data=['student_data.xml', 'res.partner.csv', 'data.sql'])),
            ('foo/student_data.xml', b"""
                <data>
            ...
            ('bar/__manifest__.py', self.manifest_content(data=['student_data.xml'])),
            ('bar/static/src/js/bar.js', b"console.log(_t('baz')"),
            ('bar/student_data.xml', b"""
                <data>
    ...
    def test_import_zip_extract_only_useful(self):
        ...
        files = [
            ('foo/__manifest__.py', self.manifest_content(data=['student_data.xml', 'res.partner.xls'])),
            ('foo/student_data.xml', b"""
                <data>
                    <record id="foo" model="res.partner">
                        <field name="name">foo</field>
        ...
        self.assertIn(
            'student_data.xml', extracted_files,
            "student_data.xml must be in the extracted files as its in the manifest's data")
        self.assertIn(
...
class TestImportModuleHttp(TestImportModule, odoo.tests.HttpCase):
    ...
    def test_import_module_field_file(self):
        files = [
            ('foo/__manifest__.py', self.manifest_content(data=['student_data.xml'])),
            ('foo/student_data.xml', b"""
                <data>
